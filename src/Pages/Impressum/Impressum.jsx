import style from "../Impressum/Impressum.module.css";
...
const Impressum = () => {
  return (
    <div className={style.container}>
      ...
      <p>
        Milon Mitra <br />
        Wiedstocker Dorfstraße 24a
        <br />
        14974 Ludwigsfelde-Wiedstock <br /> <br />
      </p>
      <p>
        {" "}
      ...
      <p>
        ...
        Telefon: +49160 91617759
        <br />
        E-Mail: deraltewanderer[at]web.de
        <br />
        <br />
      </p>
      <p>
        ...
        Wiedstocker Dorfstraße 24a
        <br />
        14974 Ludwigsfelde-Wiedstock <br />
      </p>{" "}
      <br />
      <p>
